...
export declare const names: (accTypes?: string | undefined) => NoteName[];
export declare function tokenize(str?: Note | Midi): ["" | "C" | "D" | "E" | "F" | "G" | "A" | "B", string, string, string] | null;
export declare const props: (str: string | number) => Readonly<NoNoteProps> | Readonly<NoteProps>;
export declare const name: (str: string) => NoteName;
export declare const pc: (str: string) => "C" | "C#" | "Db" | "D" | "D#" | "Eb" | "E" | "F" | "F#" | "Gb" | "G" | "G#" | "Ab" | "A" | "A#" | "Bb" | "B" | null;
...
export declare const from: (fromProps?: Partial<NoteProps>, baseNote?: string | null | undefined) => OrNull<string>;
export declare const build: (fromProps?: Partial<NoteProps>, baseNote?: string | null | undefined) => OrNull<string>;
