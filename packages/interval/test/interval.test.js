...
describe('tonal-interval', function () {
  test('toInterval - get interval names', function () {
    expect(map(ivl.toInterval, '1P 2M m3 P-4 5 blah')).toEqual([ '1P', '2M', '3m', '-4P', null, null ])
  })

  test('toInterval - invalid intervals', function () {
  ...
  test('get interval name from semitones', function () {
  ...
  test('get interval class', function () {
