...
describe('tonal-pitch', function () {
  ...
  test('get focts from pitch object', function () {
    expect(p.focts(p.parseIvl('2M'))).toBe(-1)
    expect(p.focts(p.parseIvl('-2M'))).toBe(1)
  })

  test('get dir from pitch object', function () {
  ...
  test('get chroma from a pitch object', function () {
  ...
  test('parse note', function () {
    expect(p.parseNote('Cb4')).toEqual([ 'tnlp', [ -7, 8 ] ])
  })

  test('parse interval', function () {
  ...
  test('interval to string', function () {
