...
describe('tonal-midi', function () {
  test('toMidi - map note names to note numbers', function () {
  ...
  test('note - partially applied with true', function () {
