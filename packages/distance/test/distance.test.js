...
describe('tonal-distance', function () {
  test('get distance between notes', function () {
    var fromC3 = map(dist.interval('C3'))
    expect(fromC3('C3 e3 e4 c2 e2')).toEqual([ '1P', '3M', '10M', '-8P', '-6m' ])
  })

  test('distances between pitch classes are always ascending', function () {
