...
describe("tonal-scale", () => {
  test("parse", () => {
    ...
    expect(scale.parse("melodic minor")).toEqual({
      tonic: false,
      type: "melodic minor"
    });
  ...
  test("intervals", () => {
    ...
    expect(scale.intervals("major")).toEqual([
      "1P",
      "2M",
      "3M",
      "4P",
  ...
  test("notes", () => {
    ...
    expect(scale.notes("Eb bebop")).toEqual([
      "Eb",
      "F",
      "G",
      "Ab",
  ...
  test("get", () => {
    expect(scale.get("major", "C")).toEqual([
      "C",
      "D",
      "E",
      "F",
    ...
    expect(scale.get("major", "C2")).toEqual([
      "C2",
      "D2",
      "E2",
      "F2",
    ...
    // alias
    expect(scale.get("ionian", "C")).toEqual([
      "C",
      "D",
      "E",
      "F",
    ...
    // intervals
    expect(scale.get("major", false)).toEqual([
      "1P",
      "2M",
      "3M",
      "4P",
    ...
    // partially applied
    expect(scale.get("major")("Db3")).toEqual([
      "Db3",
      "Eb3",
      "F3",
      "Gb3",
