...
describe("tonal-range", () => {
  test("numeric - multiple notes in a string", () => {
    expect(range.numeric("C2 F2 Bb1 C2")).toEqual([
      36,
      37,
      38,
      39,
  ...
  test("fifths", () => {
    expect(range.fifths("C", [0, 6])).toEqual([
      "C",
      "G",
      "D",
      "A",
  ...
  test("numeric - notes array", () => {
    expect(range.numeric("C4 C5")).toEqual([
      60,
      61,
      62,
      63,
    ...
    expect(range.numeric(["C5", "C4"])).toEqual([
      72,
      71,
      70,
      69,
