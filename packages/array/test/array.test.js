...
describe("tonal-array", () => {
  ...
  describe("sort", () => {
    ...
    it("sort pitch classes", () => {
      expect(_.sort("a b c d e f g")).toEqual([
        "C",
        "D",
        "E",
        "F",
    ...
    it("sort intervals", () => {
      expect(_.sort("2m 1P 3m 3M 4A 4P 9m 8P")).toEqual([
        "1P",
        "2m",
        "3m",
        "3M",
      ...
      expect(_.sort("2m 1P 3m 3M 4A 4P 9m 8P", false)).toEqual([
        "9m",
        "8P",
        "4A",
        "4P",
  ...
  it("select", () => {
    ...
    expect(_.select("1 -3 12 4", "C D E F G A B")).toEqual([
      "C",
      null,
      null,
      "F"
