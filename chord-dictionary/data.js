...
module.exports = {
  ...
  "1P 3M 5P 7M 9M": ["major seventh b6", "maj7b6 ma7b6 M7b6"],
  // ==Minor==
  // '''Normal'''
  ...
  "1P 3m 5d 7d": ["diminished seventh", "dim7 ° °7"],
  "1P 3m 5d 7m $$$(♭9 $$$or": ["half-diminished", "m7b5 ø"],
  // ==Dominant/Seventh==
  // '''Normal'''
  ...
  "1P 4P 5P 7m 9M 11P": ["eleventh (special voicing)", "11"],
  "1P 4P 5P 9m": ["suspended 4th b9", "b9sus phryg"],
  // ==Polychords==
  "2M 4A 6M 1P 3M 7M": ["D|Cmaj7", "Cmaj13(#11)"],
  "2M 4A 6M 1P 3M 7m": ["D|C7", "C13(#11)"],
  "6M 2m 3M 1P 3M 7m": ["A|C7", "C13(b9)"],
  "4A 7M 2m 1P 3M 7m": ["F#7|C(bass)", "C7b9♭5"],
  "6m 1P 3m 1P 3M 7m": ["Ab|C7", "C7alt"],
  "7m 2M 4P 1P 3M 5d": ["Bb|Cdim", "Cø11"],
  "5P 7m 2M 1P $$$b 5P": ["Gm|C", "C9"],
  "5P 7M 2M 1P $$$b 5P": ["G|C", "Cmaj9"],
  ...
  "1P 3M 5P 7M 9M 13M": [null, "M13 maj13"],
  ...
  "1P 3m 5P 7m 9M 11P 13M": [null, "m13 _13"],
  "1P 3m 5P 9M": [null, "madd9"],
  "1P 3m 5d 13M": [null, "o7 diminished m6b5 dim7"],
  ...
  "1P 3m 6m 7m 9M 11P": [null, "m11A 5"],
